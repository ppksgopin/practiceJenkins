...
import {AssociationLanding} from './routes' ;
...
class Association extends Component {
    ...
    render() {
        return (
            <AssociationContainer className={this.state.noht ? "noht" : ""} id="targetDiv">
                <Header/>
                <Switch>
                    <Route exact path={AssociationsRoute()} component={AssociationLanding}/>
