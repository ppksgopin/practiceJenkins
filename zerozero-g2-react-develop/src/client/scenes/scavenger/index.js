...
import {ScavengerLanding, Appointment, Reservation, ReservationFinish, Order, Choice} from './routes' ;
...
const ScavengerContainer = styled.div`
  // padding: 130px 0 0;
  // min-height: 95vh;
  ${box};
...
class Scavenger extends Component {
    ...
    render() {
        return (
            <ScavengerContainer className={this.state.noht ? "noht" : ""} id="targetDiv">
                <Header/>
                <Switch>
                    <Route exact path={ScavengerRoute()} component={ScavengerLanding}/>
