...
import {NEproductsReservationRoute, NEproductsRoute} from '../../../../../../commons/routePaths';
            ...
            <div className="bg">
                ...
                <AppointmentInfo>
                    ...
                    <div className="blocks">
                        ...
                        <div className="block">
                            <Link to={NEproductsReservationRoute(slug)} style={{textDecoration: 'none'}}>
                                <BlueButton>直接預約回收</BlueButton>
                            </Link>
                            <div style={{'textAlign': 'center', 'fontSize': '14px'}}>or</div>
                            <br/>
                            <Link to={NEproductsRoute()} style={{textDecoration: 'none'}}>
