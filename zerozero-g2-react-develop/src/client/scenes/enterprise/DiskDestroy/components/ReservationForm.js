...
const Container = styled.div`
	...
	.step{
		...
		&.step1{
			>div.pageImage{
				background:url(${awsUrl("epFormStep1_disk_20190101.png")}) no-repeat center center;
...
class ReservationForm extends Component {
	...
	joinLineButton() {
        gtag('event','conversion',{'send_to':'AW-851066983/4oKECIyGx4MBEOeA6ZUD'});
    }


    toSignUp() {
        gtag('event','conversion',{'send_to':'AW-851066983/LAozCOn6xoMBEOeA6ZUD'});
    }
    ...
    submit(values) {
        ...
        new Promise((resolve, reject) => {
    		resolve(this.props.submitDiskDestroyForm(values));
		})
			.then((response) => {
                this.nextPage();
            })
