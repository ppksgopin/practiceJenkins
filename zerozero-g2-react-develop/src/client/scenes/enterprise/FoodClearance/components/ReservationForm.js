...
const Container = styled.div`
	...
	.step{
		...
		&.step1{
			>div.pageImage{
				background:url(${awsUrl("epFormStep1_food_20190101.png")}) no-repeat center center;
...
class ReservationForm extends Component {
    constructor(props) {
        ...
        // console.log('get in ReservationForm Constructor');
    }
	...
	joinLineButton() {
        gtag('event','conversion',{'send_to':'AW-851066983/JIpYCKKR1YcBEOeA6ZUD'});
    }



    toSignUp() {
        gtag('event','conversion',{'send_to':'AW-851066983/fj4ICNqQ1YcBEOeA6ZUD'});
    }
