...
import {sludgeTreatmentType} from '../../../commons/constants/actionTypes';
import createReducer from '../../../utils/createReducer';


const types = sludgeTreatmentType;
...
const LOAD_PACK_TYPES = (state, {payload}) => {
    return state.update('PACKTYPES', value => fromJS(payload));
};
...
const handlers = {
    ...
    [types.LOAD_PACK_TYPES]: LOAD_PACK_TYPES,
